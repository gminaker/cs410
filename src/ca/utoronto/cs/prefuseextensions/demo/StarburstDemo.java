 ...
 * 
 * @version 1.1
 * @author Christopher Collins through modification of original code by jeffrey
 *         heer
 */
public class StarburstDemo extends Display {
	...
	public StarburstDemo(Graph g, String label) {
		...
		// treeLayout.setAngularBounds(-Math.PI/2, Math.PI); // TODO add widget
		// to interactively adjust this
	...
	public static JPanel demo(Graph g, final String label) {
		...
		JValueSlider filterLevelSlider = new JValueSlider("Filter level", 1,
				20, 1);
